...
public class ApproveFinanceDTO {
    ...
    @Autowired
    public ApproveFinanceDTO(Integer id_status, Integer id_travel, String fullname, LocalDate date,
            String start_journey, String end_journey, LocalDate start_date, LocalDate end_date, String description,
            String status) {
